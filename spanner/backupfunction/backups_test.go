...
func TestIntegrationCreateBackup(t *testing.T) {
	...
	_, err := CreateBackup(ctx,os.Stdout,databaseAdmin, testDatabaseName, expires,backupPrefix)
	if err != nil {
		t.Fatal(err)
	}
	defer func() {
		//TODO listbackups and delete go-test- backups
	}()
